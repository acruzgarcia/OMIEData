...
from OMIEData.Downloaders.EnergyByTechnologyDownloader import EnergyByTechnologyDownloader
from OMIEData.Downloaders.EnergyByTechnologyDownloader import SystemType
